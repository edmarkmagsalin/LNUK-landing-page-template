...
$('#productform').submit(function(e) {
  // Run your own validation functions etc.
  ...
  if (!IsValid) {
    ...
    var PostURL =
      'https://prefserviceqa.smartwebportal.co.uk/preferencecentrewebservice.ashx?action=SaveWidget&formID=' +
      FormID +
      '&LicenseID=' +
      LicenseID;
    ...
    RecordObject.Postcode = $('input[name="00N30000009PrYS"]').val(); // Postcode
    RecordObject.Country = $('select[name="00N3000000BZj7M"]').val(); // Country
    RecordObject.SourceCode = $('input[name="00N30000007eScv"]').val(); // URL
    ...
    if (typeof $('#adminheaderid').val() !== 'undefined') {
      ...
      var headerfooter = $('#adminheaderid')
        .val()
        .split('|');
      ...
      AdminPreference.OptIn = $('#adminoptin')
        .find(':selected')
        .val();
    ...
    //console.log("PrefArray = " + JSON.stringify(PreferenceArray));
    //console.log("AdminPrefArray = " + JSON.stringify(AdminPreferenceArray));
    //console.log("FlagArray = " + JSON.stringify(FlagArray));
    ...
    $.ajax({
      data: {
        DataObject: JSON.stringify(RecordObject)
      },
      url: PostURL,
      type: 'POST',
      dataType: 'json',
